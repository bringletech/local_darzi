class Update_Customer_Profile_response_Model {
  Data? data;
  String? message;
  bool? status;

  Update_Customer_Profile_response_Model(
      {this.data, this.message, this.status});

  Update_Customer_Profile_response_Model.fromJson(Map<String, dynamic> json) {
