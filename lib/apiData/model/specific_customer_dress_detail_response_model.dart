class Specific_Customer_Dress_Detail_Response_Model {
  Specific_Customer_Dress_Detail? data;
  String? message;
  bool? status;

  Specific_Customer_Dress_Detail_Response_Model(
      {this.data, this.message, this.status});

  Specific_Customer_Dress_Detail_Response_Model.fromJson(
      Map<String, dynamic> json) {
    data = json['data'] != null ? new Specific_Customer_Dress_Detail.fromJson(json['data']) : null;
...
class Specific_Customer_Dress_Detail {
  String? id;
  String? mobileNo;
  String? name;
  String? dressImgUrl;
  ...
  Specific_Customer_Dress_Detail.fromJson(Map<String, dynamic> json) {
    id = json['id'];
