class Specific_Stitching_History_Response_Model {
  Specific_Stiching_History_Data? data;
  String? message;
  bool? status;

  Specific_Stitching_History_Response_Model(
      {this.data, this.message, this.status});

  Specific_Stitching_History_Response_Model.fromJson(
      Map<String, dynamic> json) {
    data = json['data'] != null ? new Specific_Stiching_History_Data.fromJson(json['data']) : null;
...
class Specific_Stiching_History_Data {
  String? id;
  String? mobileNo;
  String? name;
  String? dressImgUrl;
  ...
  Specific_Stiching_History_Data(
      {this.id,
        this.mobileNo,
        this.name,
        this.dressImgUrl,
  ...
  Specific_Stiching_History_Data.fromJson(Map<String, dynamic> json) {
    id = json['id'];
