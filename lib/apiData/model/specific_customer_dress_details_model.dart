class Specific_Customer_Dress_Details_Model {
  List<Data>? data;
  String? message;
  bool? status;

  Specific_Customer_Dress_Details_Model({this.data, this.message, this.status});

  Specific_Customer_Dress_Details_Model.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
