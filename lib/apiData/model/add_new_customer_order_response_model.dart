class Add_New_Customer_Order_Response_Model {
  Add_New_Customer_Order_Data? data;
  String? message;
  bool? status;

  Add_New_Customer_Order_Response_Model({this.data, this.message, this.status});

  Add_New_Customer_Order_Response_Model.fromJson(Map<String, dynamic> json) {
    data = json['data'] != null ? new Add_New_Customer_Order_Data.fromJson(json['data']) : null;
...
class Add_New_Customer_Order_Data {
  String? id;
  String? mobileNo;
  String? name;
  String? dressImgUrl;
  ...
  Add_New_Customer_Order_Data.fromJson(Map<String, dynamic> json) {
    id = json['id'];
