...
class NewOrderReceivedNotificationScreen extends StatefulWidget {
  final String notificationId;
  final Locale locale;
  NewOrderReceivedNotificationScreen({super.key,required this.notificationId,required this.locale});

  @override
  State<NewOrderReceivedNotificationScreen> createState() => _NewOrderReceivedNotificationScreenState();
}

class _NewOrderReceivedNotificationScreenState extends State<NewOrderReceivedNotificationScreen> {
                          ...
                          children: [
                            Text(
                              ...
                              style: TextStyle(
                                ...
                                fontFamily: 'Inter',
                                color: status == "New Order Received"
                            ...
                            Padding(
                              ...
                              child: Text(
                                status.toString() == "New Order Received"?
