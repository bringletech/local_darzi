...
class CompletedOrderNotificationScreen extends StatefulWidget {
  final String notificationId;
  final Locale locale;
  CompletedOrderNotificationScreen({super.key,required this.notificationId,required this.locale});

  @override
  State<CompletedOrderNotificationScreen> createState() => _CompletedOrderNotificationScreenState();
}

class _CompletedOrderNotificationScreenState extends State<CompletedOrderNotificationScreen> {
    ...
    return  WillPopScope(
      ...
      child:Scaffold(
        ...
        appBar: CustomAppBarWithBack(
          title: AppLocalizations.of(context)!.complete_Orders,
          hasBackButton: true,
