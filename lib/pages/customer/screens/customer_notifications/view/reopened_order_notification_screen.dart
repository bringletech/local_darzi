...
class ReopenedOrderNotificationScreen extends StatefulWidget {
  final String notificationId;
  final Locale locale;
  ReopenedOrderNotificationScreen({super.key,required this.notificationId,required this.locale});

  @override
  State<ReopenedOrderNotificationScreen> createState() => _ReopenedOrderNotificationScreenState();
}

class _ReopenedOrderNotificationScreenState extends State<ReopenedOrderNotificationScreen> {
  ...
  Widget build(BuildContext context) {
    return  WillPopScope(
      ...
      child:Scaffold(
        appBar: AppBar(
          title: Text(
            AppLocalizations.of(context)!.order_reopened_title,
        ...
        //   title: AppLocalizations.of(context)!.order_reopened_title,
        //   hasBackButton: true,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                status.toString() == "Order Reopened"?
                                AppLocalizations.of(context)!.order_re_open:
