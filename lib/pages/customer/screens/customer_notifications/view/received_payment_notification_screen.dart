...
class ReceivedPaymentNotificationScreen extends StatefulWidget {
  final String notificationId;
  final Locale locale;
  ReceivedPaymentNotificationScreen({super.key,required this.notificationId,required this.locale});

  @override
  State<ReceivedPaymentNotificationScreen> createState() => _ReceivedPaymentNotificationScreenState();
}

class _ReceivedPaymentNotificationScreenState extends State<ReceivedPaymentNotificationScreen> {
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                ...
                                color: status == "Received"
                                    ?AppColors.statusColor:status == "PaymentDone"?AppColors.statusColor:AppColors.primaryRed,
                              ),
                            ),
                            SizedBox(width: 5,),
                            Padding(
