...
class ReceivedOrderNotificationScreen extends StatefulWidget {
  final String notificationId;
  final Locale locale;
  ReceivedOrderNotificationScreen({super.key,required this.notificationId,required this.locale});

  @override
  State<ReceivedOrderNotificationScreen> createState() => _ReceivedOrderNotificationScreenState();
}

class _ReceivedOrderNotificationScreenState extends State<ReceivedOrderNotificationScreen> {
  ...
  Widget build(BuildContext context) {
    return  WillPopScope(
      ...
      child:Scaffold(
        ...
        appBar: AppBar(
          title: Text(
            AppLocalizations.of(context)!.order_received_title,
