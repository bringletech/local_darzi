...
class CancelledOrderNotificationScreen extends StatefulWidget {
  final String notificationId;
  final Locale locale;
  CancelledOrderNotificationScreen(
      {super.key, required this.notificationId, required this.locale});

  @override
  State<CancelledOrderNotificationScreen> createState() =>
      _CancelledOrderNotificationScreenState();
}

class _CancelledOrderNotificationScreenState
    extends State<CancelledOrderNotificationScreen> {
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    specific_customer_dress_detail!
                                            .orderData!.name ??
  ...
  loadUpdateData(String notificationId) {
    setState(() {
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) async {
        SpecificNotificationResponseModel model = await CallService()
            .getCustomerSpecificNotificationDetail(notificationId);
        setState(() {
          isLoading = false;
