...
import 'package:darzi/common/utils/half_clipper.dart';
import 'package:darzi/common/utils/half_painter.dart';
import 'package:darzi/common/widgets/tab_data.dart';
import 'package:darzi/common/widgets/tab_item.dart';
...
class CircleBottomNavigation extends StatefulWidget {
  ...
  const CircleBottomNavigation({
    ...
    this.arcHeight = 0,
    this.arcWidth = 0,
    this.circleOutline = 0,
    this.shadowAllowance = 0,
...
class _CircleBottomNavigationState extends State<CircleBottomNavigation>
  ...
  void didChangeDependencies() {
    ...
    circleColor = widget.circleColor ?? Colors.grey[100]!;

    activeIconColor = widget.activeIconColor ?? theme.colorScheme.onPrimary;

    barBackgroundColor =
        widget.barBackgroundColor ?? AppColors.primaryRed;
    textColor =
